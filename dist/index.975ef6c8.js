...
const API = new (0, _fetchWrapperJsDefault.default)("https://firestore.googleapis.com/v1/projects/jsdemo-3f387/databases/(default)/documents/");
const appData = new (0, _appDataJsDefault.default)();
...
const displayEntry = (name, carbs, protein, fat)=>{
    ...
    list.insertAdjacentHTML("beforeend", `<li class="card">
        <div>
          <h3 class="name">${(0, _helpersJs.capitalize)(name)}</h3>
          <div class="calories">${(0, _helpersJs.calculateCalories)(carbs, protein, fat)} calories</div>
          <ul class="macros">
...
form.addEventListener("submit", (event)=>{
    ...
    API.post("izrizenTest", {
        ...
        if (data.error) {
            // there was an error
            (0, _snackbarDefault.default).show("Some data is missing.");
            return;
        }
        (0, _snackbarDefault.default).show("Food added successfully.");
...
},{"./fetch-wrapper.js":"5hTQM","./helpers.js":"ecN5O","snackbar":"nwWOh","./app-data.js":"lWRJn","snackbar/dist/snackbar.min.css":"40LVv","chart.js/auto":"hCqnV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5hTQM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"nwWOh":[function(require,module,exports) {
"use strict";
var _snackbar = require("a192e19b82c67aa1");
...
},{"a192e19b82c67aa1":"hGJCx"}],"hGJCx":[function(require,module,exports) {
"use strict";
...
},{}],"lWRJn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class AppData {
    constructor(){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"40LVv":[function() {},{}],"hCqnV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequireaec4")
